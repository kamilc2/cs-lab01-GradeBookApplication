...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void HelpCommand()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Create 'Name' 'Type' 'Weighted' - Creates a new gradebook where 'Name' is the name of the gradebook, and 'Type' is what type of grading it should use, and 'Weighted' is wheter or not grades should be weighted (true or false) .");
            Console.WriteLine();
